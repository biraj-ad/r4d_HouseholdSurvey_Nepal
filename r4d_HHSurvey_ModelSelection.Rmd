...
#note: i haven't converted tlu to tlu.log because it produces inf values
#removed WaterShortage and Drr since i converted them to WaterAcess and DisasterFree or not
#(the variables are framed in a way of whether they have access to them or not)
...
```{r reading }
model_supp_subset <- readRDS("model_selection_subset20.RDS")
#visualizing AIC Values
plot(model_supp_subset$AICc)
abline(h = (min(model_supp_subset$AICc) + 2), col = "red")
```